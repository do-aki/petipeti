...
/* $Id: tidy.c 313663 2011-07-25 11:35:02Z felipe $ */
...
static PHP_MINFO_FUNCTION(tidy)
{
	...
	php_info_print_table_row(2, "Extension Version", PHP_TIDY_MODULE_VERSION " ($Id: tidy.c 313663 2011-07-25 11:35:02Z felipe $)");
